...
| Day 62 | 5 | `getpgrp` / `setpgid` / `setsid` / `getpgid` / `getsid` | 81 / 82 / 147 / 151 / 310 | 进程组与会话 |
...
54. 对照填写 `notes/daily/day-0N.md`  

完成 Day 7 后再进入第 2 周；不要跳周。下一步：**Day 62** → `getpgrp` / `setpgid` / `setsid` / `getpgid` / `getsid`。
